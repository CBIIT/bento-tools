...
import ExpandableSectionStyle from './SideBarComponents/FacetFilter/ExpandableSection.Style';
...
const SideBarContent = ({ classes, props }) => {
  const {
  ...
  console.log(sideBarSectionsConfig);
      ...
      <div>
        ...
        <List component="nav" aria-label="filter cases" classes={{ root: classes.listRoot, divider: classes.dividerRoot }}>
          <FacetFilter
            ...
            styles={ExpandableSectionStyle}
            config={sideBarSectionsConfig}
          />
        </List>
      </div>
      )}
